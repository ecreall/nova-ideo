...
from novaideo.content.processes.challenge_management.behaviors import Associate
...
class AssociateView(AssociateIdeaView):
    title = _('Associate the challenge')
    description = _("Associate the challenge to an other content")
