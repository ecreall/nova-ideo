    ...
    def _init_definition(self):
        self.defineNodes(
                ...
                archive = ActivityDefinition(contexts=[ArchiveQuestion],
                                       ...
                                       title=_("Archive"),
                                       groups=[]),
                present = ActivityDefinition(contexts=[PresentQuestion],
                                       description=_("Share the question with others"),
                                       title=_("Share"),
                                       groups=[]),
                comment = ActivityDefinition(contexts=[CommentQuestion],
                                       description=_("Comment the question"),
                                       title=_("Comment"),
                                       groups=[]),
                answer = ActivityDefinition(contexts=[AnswerQuestion],
                ...
                see = ActivityDefinition(contexts=[SeeQuestion],
                                       ...
                                       title=_("Details"),
                                       groups=[]),
                support = ActivityDefinition(contexts=[SupportQuestion],
                                       description=_("This question is useful"),
                                       title=_("This question is useful"),
                                       groups=[]),
                oppose = ActivityDefinition(contexts=[OpposeQuestion],
    ...
    def _init_definition(self):
        self.defineNodes(
                ...
                archive = ActivityDefinition(contexts=[ArchiveAnswer],
                                       ...
                                       title=_("Archive"),
                                       groups=[]),
                present = ActivityDefinition(contexts=[PresentAnswer],
                                       description=_("Share the answer with others"),
                                       title=_("Share"),
                                       groups=[]),
                comment = ActivityDefinition(contexts=[CommentAnswer],
                ...
                see = ActivityDefinition(contexts=[SeeAnswer],
                                       ...
                                       title=_("Details"),
                                       groups=[]),
                support = ActivityDefinition(contexts=[SupportAnswer],
                                       description=_("This answer is useful"),
                                       title=_("This answer is useful"),
                                       groups=[]),
                oppose = ActivityDefinition(contexts=[OpposeAnswer],
