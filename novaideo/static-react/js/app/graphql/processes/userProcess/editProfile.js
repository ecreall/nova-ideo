      ...
      optimisticResponse: {
        ...
        editProfile: {
          ...
          profile: {
            ...
            locale: locale,
            picture: picture && {
              id: picture.id || `picture-id${context.id}`,
              oid: picture.oid || `picture-oid${context.id}`,
              title: picture.name,
              url: picture.preview.url,
              isImage: picture.preview.type === 'image',
              variations: [],
              size: picture.size || 0,
