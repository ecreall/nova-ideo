...
import { moderationPublish } from '../../../../graphql/processes/ideaProcess';
import ModerationPublish from '../../../../graphql/processes/ideaProcess/mutations/ModerationPublish.graphql';
...
export default withStyles(styles, { withTheme: true })(
  graphql(ModerationPublish, {
    props: function (props) {
      return {
        publishIdea: moderationPublish(props)
      };
    }
  })(Dumbpublish)
);