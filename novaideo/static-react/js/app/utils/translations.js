...
const Translations = {
  fr: {
    ...
    common: {
      ...
      failedSubmission: "Désolé, une erreur est survenue lors du traitement de votre requête. Veuillez réessayer ultérieurement.",
  ...
  en: {
    ...
    common: {
      ...
      failedSubmission: "Sorry, there has been an error processing your request, please try again later.",
