...
@process_definition(name='googleprocess', id='googleprocess')
class GoogleProcess(ProcessDefinition, VisualisableElement):
    isUnique = True

    def __init__(self, **kwargs):
        super(GoogleProcess, self).__init__(**kwargs)
        self.title = _('Google process')
        self.description = _('Google process')
...
CONNECTOR_PROCESSES.append('googleprocess')
