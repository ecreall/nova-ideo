...
$(
  document
).on("click", ".new-idea-form button.ajax-button.validate-btn", function(
  event
) {
  var button = $(this)
  var form = $(button.parents(".new-idea-form").first())
  var danger_messages_container = $(
    $(form.parents(".ajax-form").first()).find("#messagedanger")
  )
  var success_messages_container = $(
    $(form.parents(".ajax-form").first()).find("#messagesuccess")
  )
  var dict_post = {}
