...
function drop(e) {
  ...
  var target = $(e.currentTarget)
  $(".select-container").removeClass("selected-container")
  var targetselect = $(target.parents(".form-group").first())
    .find("select")
    .first()
  var oldselect = $(draggedElement.parents(".form-group").first())
    .find("select")
    .first()
...
$(document).ready(function() {
  ...
  $(".explanation-amendment .global-action").on("click", function() {
    var explanation_items = $($(this).parents(".explanation-amendment").first())
      .find(".items-control")
      .first()
