function search_result_template(oid) {
  return (
    '<span data-oid="' +
    oid +
    '" id="search_container_' +
    oid +
    '" class="live-search-container select2-container select2-container--default select2-container--open" style="position: absolute; z-index: 1200;">' +
