function open_add_content_form() {
  if ($(".modal-home-add-content").length == 0) {
    $(document.body).append(
      '<div class="modal-backdrop fade in modal-home-add-content"></div>'
    )
  }
  ...
  add_content_form
    .find(
      ".form-group:not(.content-preview-form)," +
        ".form-group label," +
        ".form-group.content-preview-form #desc"
    )
    .slideDown()
...
$(document).mouseup(function(e) {
  ...
  if (
    ...
    $(e.target).parents("body").length != 0
  ) {
    // ... nor a descendant of the container
    if (
      !$(".home-add-content .form-group.content-preview-form textarea").val()
    ) {
...
$(
  ...
  "change",
  '.home-add-content form input[name="title"], .home-add-content form select[name="keywords"]',
  function(event) {
    var $this = $(this)
...
$(document).on("submit", ".home-add-content .home-add-idea form", function(
  event
) {
  var $this = $(this)
  ...
  if (title == "" || text == "" || !keywords || keywords.length == 0) {
    ...
    var input = null
    var error_help =
      '<p class="help-error help-block">' +
      novaideo_translate("Required") +
      "</p>"
    alert_component({
...
$(document).on("submit", ".home-add-content .home-add-question form", function(
  event
) {
  var $this = $(this)
  if ($this.hasClass("pending")) {
...
$(document).ready(function() {
  $(".home-add-content.closed  span.form-icon").on("click", function() {
    $(this)
      .siblings("div.content-form")
      .find(".content-preview-form textarea")
      .click()
      .focus()
  })

  $(".home-add-content.closed .form-group.content-preview-form").click(function(
    e
  ) {
  ...
  $(".home-content-nav>li>a").click(function(e) {
    var add_content_form = $(".home-add-content")
    var container = add_content_form
      .parents(".home-add-content-container")
      .first()
