...
FACEBOOK_CONSUMER_KEY="${FACEBOOK_CONSUMER_KEY:-}"
FACEBOOK_CONSUMER_SECRET="${FACEBOOK_CONSUMER_SECRET:-}"
...
sed -i \
    ...
    -e "s|TWITTER_CONSUMER_KEY|$TWITTER_CONSUMER_KEY|" \
    -e "s|TWITTER_CONSUMER_SECRET|$TWITTER_CONSUMER_SECRET|" \
    -e "s|GOOGLE_CONSUMER_KEY|$GOOGLE_CONSUMER_KEY|" \
    -e "s|GOOGLE_CONSUMER_SECRET|$GOOGLE_CONSUMER_SECRET|" \
    -e "s|FACEBOOK_CONSUMER_KEY|$FACEBOOK_CONSUMER_KEY|" \
    -e "s|FACEBOOK_CONSUMER_SECRET|$FACEBOOK_CONSUMER_SECRET|" \
